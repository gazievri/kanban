  ...
  return (
    <div className="welcome">
      ...
      <div className="welcome__about">
        <svg
          id="Layer_1"
          className="header__hedghog welcome__hedhog"
          data-name="Layer 1"
      ...
      <p className="welcome__text">
        HedgTasker is a development management method that implements the
        principle of "just in time" and contributes to an even distribution of
