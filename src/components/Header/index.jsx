...
const Header = ({ setShowEdit, showEdit, clickOnEditBordMenu }) => {
  ...
  const TEMP_DATA_FOR_POPUP = [
    ...
    },
    {
      label: "Delete Board",
      color: "#EA5555",
      action: () => dispatch(showModal("RemoveBoard")),
    },
  ];
